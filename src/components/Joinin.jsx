...
function Joinin() {
	return (
		<div className="w-full">
			<div
				className={`${poppins.className} flex flex-col items-center gap-[2.8rem] max-w-[41rem] mt-[4rem] mx-auto`}>
